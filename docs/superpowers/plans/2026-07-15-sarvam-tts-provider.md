...
- Exactly 9 voices exposed: `anushka`, `abhilash`, `manisha`, `vidya`, `arya`, `karun`, `hitesh`, `diya`, `maitreyi` — `anushka` first/default (matches the plugin's own built-in default).
